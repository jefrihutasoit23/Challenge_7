    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatchers("/","/showFile/**","/v1/showFile/**","/v1/upload", "/v1/user-register/**","/v1/merchant-register/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/v1/user-login/**",
                        "/v1/merchant-login/**","/v1/forget-password/**", "/oauth/authorize**", "/login**", "/error**", "/products/**","/productsAuth/**", "/merchants/**","/merchantsAuth/**", "/customers/**",
                        "/customersAuth/**", "/orders/**", "/user-login/**")
                .permitAll()
