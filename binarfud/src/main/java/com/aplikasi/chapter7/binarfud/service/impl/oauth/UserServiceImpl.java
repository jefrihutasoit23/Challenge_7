...
import com.aplikasi.chapter7.binarfud.service.oauth.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public Map registerManual(RegisterUserModel objModel) {
        ...
        try {
            ...
            customer.setNama(objModel.getFullname());
            customer.setAlamat(objModel.getAlamat());
            customer.setJenis_kelamin(objModel.getJenis_kelamin());
            //step 1 :
